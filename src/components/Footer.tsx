...
const Footer = () => {
  return (
    <div className="h-600px 2xl:h-[350px] bg-[rgb(174,185,206)] mt-5 px-12">
      <div className="max-w-[1220px] grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mx-auto h-full gap-3 py-6">
        ...
        <div className="flex items-center w-full ml-10 lg:ml-0">
        ...
        <div className="flex w-full items-center justify-center">
          <div className="tracking-wide flex flex-col  gap-3 text-gray-600 ml-6">
            ...
            <div className="flex">
              ...
              <button className="ml-2 rounded-md bg-pink-500 w-1/3 text-white">
                Join
              </button>
            </div>
